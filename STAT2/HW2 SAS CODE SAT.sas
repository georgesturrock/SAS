...
title 'Extra Credit - OLS Confidence Intervals';
run;                                                                                                                                                                                                                     
quit;                                                                                                                                                                                                                    
...
model SAT = lTakers Income Years Public Expend Rank / selection=LASSO( choose=CV stop=CV) CVdetails;                                                                                          
modelaverage tables= (effectselectpct(all) parmest(all)) alpha=0.05;                                                                                                                                                                                                                                              
title 'Extra Credit - LASSO Confidence Intervals';                                                                                                                                             
run;                                                                                                                                                                                                                     
quit;
...
proc glm data=sat3 plots=all;
class State;
model SAT = lTakers Years Expend Rank / solution clparm;
run;
ods graphics off;